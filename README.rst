...
.. image:: https://travis-ci.org/abdza/cookiecutter-flask.svg
    :target: https://travis-ci.org/abdza/cookiecutter-flask
    :alt: Build Status
...
::
    ...
    $ cookiecutter https://github.com/abdza/cookiecutter-flask.git
